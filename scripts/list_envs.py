...
All the environments are registered in the `isaac_lab_jetbot_orin` extension. They start
...
def main():
    """Print all environments registered in `isaac_lab_jetbot_orin` extension."""
